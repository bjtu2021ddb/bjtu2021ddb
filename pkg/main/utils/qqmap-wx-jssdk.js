var t = require("../@babel/runtime/helpers/classCallCheck"), e = require("../@babel/runtime/helpers/createClass"), i = 310, s = "请求参数信息有误", o = 600, r = "系统错误", n = 1e3, a = 200, l = "https://apis.map.qq.com/ws/", d = l + "place/v1/suggestion", c = "driving", u = "transit", g = {
    ...
    return e(i, [ {
        ...
        value: function(t) {
            if (t = t || {}, g.polyfillParam(t), g.checkKeyword(t)) {
                ...
                g.locationProcess(t, function(n) {
                    ...
                    t.sig && (e.sig = g.getSig(e, t.sig, "search"))) : r && !o ? (e.boundary = "rectangle(" + r + ")", 
                    t.sig && (e.sig = g.getSig(e, t.sig, "search"))) : (e.boundary = "nearby(" + n.latitude + "," + n.longitude + "," + i + "," + s + ")", 
                    t.sig && (e.sig = g.getSig(e, t.sig, "search"))), wx.request(g.buildWxRequestConfig(t, {
            ...
            if (t = t || {}, g.polyfillParam(t), g.checkKeyword(t)) {
                ...
                t.location) {
                    g.locationProcess(t, function(i) {
                        e.location = i.latitude + "," + i.longitude, t.sig && (e.sig = g.getSig(e, t.sig, "suggest")), 
                        wx.request(g.buildWxRequestConfig(t, {
                            url: d,
                            data: e
                        }, "suggest"));
                    });
        ...
        value: function(t) {
            ...
            g.locationProcess(t, function(i) {
                e.location = i.latitude + "," + i.longitude, t.sig && (e.sig = g.getSig(e, t.sig, "reverseGeocoder")), 
                wx.request(g.buildWxRequestConfig(t, {
        ...
        value: function(t) {
            if (t = t || {}, g.polyfillParam(t), !g.checkParamKeyEmpty(t, "address")) {
                ...
                t.region && (e.region = t.region), t.sig && (e.sig = g.getSig(e, t.sig, "geocoder")), 
                wx.request(g.buildWxRequestConfig(t, {
                    url: "https://apis.map.qq.com/ws/geocoder/v1/",
                    data: e
                }, "geocoder"));
        ...
        value: function(t) {
            if (t = t || {}, g.polyfillParam(t), !g.checkParamKeyEmpty(t, "to")) {
                ...
                if (t.from && (t.location = t.from), "straight" == e.mode) {
                    ...
                    i = function(i) {
                        e.from = i.latitude + "," + i.longitude, t.sig && (e.sig = g.getSig(e, t.sig, "calculateDistance")), 
                        wx.request(g.buildWxRequestConfig(t, {
        ...
        value: function(t) {
            if (t = t || {}, g.polyfillParam(t), !g.checkParamKeyEmpty(t, "to")) {
                ...
                var i;
                t.mode = t.mode || c, i = "https://apis.map.qq.com/ws/direction/v1/" + t.mode, t.from && (t.location = t.from), 
                t.mode == c && (t.from_poi && (e.from_poi = t.from_poi), t.heading && (e.heading = t.heading), 
                ...
                t.mode == u && (t.departure_time && (e.departure_time = t.departure_time), t.policy && (e.policy = t.policy));
                g.locationProcess(t, function(s) {
                    e.from = s.latitude + "," + s.longitude, t.sig && (e.sig = g.getSig(e, t.sig, "direction", t.mode)), 
                    wx.request(g.buildWxRequestConfig(t, {
                        url: i,
                        data: e
                    }, "direction"));
